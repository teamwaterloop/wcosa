...
def write_user_conf(path, board, framework, custom_flags, cosa_libs):
    """writes user config based on the values provided"""

    config_file = open(path)
    config_data = json.load(config_file)
    config_data["board"] = board
    config_data["framework"] = framework
    config_data["custom-flags"] = custom_flags
    config_data["cosa_libs"] = framework
    config_file.close()
